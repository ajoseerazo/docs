---
title: "Create Payout"
api: "POST https://stablecoin-api.sandbox.getmeru.com/payouts"
...
```bash cURL
curl --location --request POST 'https://stablecoin-api.sandbox.getmeru.com/payouts' \
...
```js Javascript
const response = await fetch('https://stablecoin-api.sandbox.getmeru.com/payouts', {
  method: 'POST',
  headers: {
