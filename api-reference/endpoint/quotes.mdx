---
title: "Create Quote"
api: "POST https://stablecoin-api.getmeru.com/quotes"
...
```bash cURL
curl --location --request POST 'https://stablecoin-api.getmeru.com/quotes' \
...
```js Javascript
const response = await fetch('https://stablecoin-api.getmeru.com/quotes', {
  method: 'POST',
  headers: {
