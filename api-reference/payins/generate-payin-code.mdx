...
api: "POST https://stablecoin-api.sandbox.getmeru.com/v1/clients/payins/qr-code"
...
```bash BRL (PIX)
curl --location --request POST 'https://stablecoin-api.sandbox.getmeru.com/v1/clients/payins/qr-code' \
