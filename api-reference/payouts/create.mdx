---
title: "Create Payout"
api: "POST https://stablecoin-api.sandbox.getmeru.com/api/v1/payouts"
...
```bash cURL
curl --location --request POST 'https://stablecoin-api.sandbox.getmeru.com/api/v1/payouts' \
...
```js Javascript
const response = await fetch('https://stablecoin-api.sandbox.getmeru.com/api/v1/payouts', {
  method: 'POST',
  headers: {
