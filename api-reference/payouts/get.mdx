...
api: "GET https://stablecoin-api.sandbox.getmeru.com/api/v1/payouts/:payout-id"
...
```bash cURL
curl --location --request GET 'https://stablecoin-api.sandbox.getmeru.com/api/v1/payouts/3ddd0e5b-6276-4b48-b756-c1fcc9a2efd1' \
--header 'Content-Type: application/json' \
--header 'api-key: <api-key>'
```

```js Javascript
const response = await fetch('https://stablecoin-api.sandbox.getmeru.com/api/v1/payouts/3ddd0e5b-6276-4b48-b756-c1fcc9a2efd1', {
  method: 'GET',
  headers: {
