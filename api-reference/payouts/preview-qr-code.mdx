...
api: "POST https://stablecoin-api.sandbox.getmeru.com/payouts/qr-codes/preview"
...
```bash cURL
curl --location --request POST 'https://stablecoin-api.sandbox.getmeru.com/payouts/qr-codes/preview' \
...
```js Javascript
const response = await fetch('https://stablecoin-api.sandbox.getmeru.com/payouts/qr-codes/preview', {
  method: 'POST',
  headers: {
