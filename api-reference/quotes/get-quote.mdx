---
title: "Get Quote"
api: "GET https://stablecoin-api.getmeru.com/api/v1/quotes/:quote-id"
...
```bash cURL
curl --location --request GET 'https://stablecoin-api.getmeru.com/api/v1/quotes/efaaf971-6d8b-4f36-be36-187c9f68fc06' \
--header 'Content-Type: application/json' \
--header 'api-key: <api-key>'
```

```js Javascript
const response = await fetch('https://stablecoin-api.getmeru.com/api/v1/quotes/efaaf971-6d8b-4f36-be36-187c9f68fc06', {
  method: 'GET',
  headers: {
