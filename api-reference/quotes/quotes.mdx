---
title: "Create Quote"
api: "POST https://stablecoin-api.sandbox.getmeru.com/api/v1/quotes"
...
```bash cURL
curl --location --request POST 'https://stablecoin-api.sandbox.getmeru.com/api/v1/quotes' \
...
```js Javascript
const response = await fetch('https://stablecoin-api.sandbox.getmeru.com/api/v1/quotes', {
  method: 'POST',
  headers: {
